use hlcl_ast::{visit, Program, Path, BranchVariant, Mod, TypeRef, Struct, Stmt, Item, Type, StructField, Identifier, Expr, Branch, Block, Class, FnParam, ItemKind};
use hlcl_ast::id::AstId;
use smallvec::SmallVec;
use hlcl_project::PathMap;
